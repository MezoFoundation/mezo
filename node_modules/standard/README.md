...
[2]: https://inimino.org/~inimino/blog/javascript_semicolons
...
*Note: To run the preceding commands, [Node.js](https://nodejs.org) and [npm](https://npmjs.com) must be installed.*
...
[sublime-2]: https://www.sublimelinter.com/en/latest/
...
[emacs-1]: https://www.flycheck.org
[emacs-2]: https://www.flycheck.org/en/latest/user/installation.html
...
JavaScript Standard Style uses [ESLint](https://eslint.org/) under-the-hood and
