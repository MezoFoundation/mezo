# prompt [![Build Status](https://secure.travis-ci.org/flatiron/prompt.svg)](https://travis-ci.org/flatiron/prompt)
...
#### Contributors: [Josh Holbrook](https://github.com/jesusabdullah), [Pavan Kumar Sunkara](https://github.com/pksunkara)
