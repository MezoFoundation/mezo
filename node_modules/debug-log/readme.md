...
> Node.js 0.12 [`util.debuglog()`](https://nodejs.org/api/util.html#util_util_debuglog_section) [ponyfill](https://ponyfill.com)
...
See the [`util.debuglog()` docs](https://nodejs.org/api/util.html#util_util_debuglog_section).
